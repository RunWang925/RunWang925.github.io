---
title: 隐私协议、Cookies、版权协议模板
cover: 'https://bitiful.814925.xyz/2024/11/15/202411151151888.jpg'
swiper_index: 10
top_group_index: 10
background: '#fff'
tags:
...
本教程参考的教程[青桔大佬](https://blog.qjqq.cn/posts/53e4.html)转载请注明来自
{% endnote %}

## 新建隐私协议、Cookies、版权协议三个页面

1. 前往你的 Hexo 博客的根目录
2. 在 Hexo 博客根目录 `[blog]`下打开终端，输入 

```SQL
hexo new page privacy  #隐私政策
hexo new page copyright #版权协议
hexo new page cookies  #Cookies
```

找到 `source/对应文件夹/index.md` 这个文件进行修改 三个文件都需要修改哈

![img](https://bitiful.814925.xyz/2024/11/15/202411151106427.png)
...
本站非常重视用户的隐私和个人信息保护。你在使用网站时，可能会收集和使用你的相关信息。通过《隐私政策》向你说明在你访问 `hexo.814925.xyz`
...
特别说明在隐私政策里面有获取cookies三方api https://api.qjqq.cn/api/Local 获取IP地址信息，有的人比较介意。就想扒了衣服裸奔一样。不喜欢自己删除那个部分即可。

设置好了可以通过屏幕下面的协议点击跳转看看会不会报错。

![image-20241115111300359](https://bitiful.814925.xyz/2024/11/15/202411151113564.png)